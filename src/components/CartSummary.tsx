...
const CartSummary = ({ handleContinueToCartAndNextStep }: { handleContinueToCartAndNextStep: () => void }) => {
  ...
  return (
    <div>
      ...
      <hr className="h-[1px]" />
      <CartItem product="Google Workspace" price={225} domain="thedesignerclub.com" />
      ...
      <div className="flex justify-between items-start py-2 px-2">
        ...
        {showCoupon && (
          <div className="flex border-dashed border border-gray-400 opacity-50 focus:opacity-100">
            <input type="text" placeholder="Enter Coupon Code" className="placeholder:text-[14px] placeholder:text-center" />
