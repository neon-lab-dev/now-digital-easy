    ...
    const whyChooseList: TWhyChoose[] = [
        {
            ...
            description: "Since 2000, we've been focused on helping customers find the best domain name as the building block of their online presence."
        },
        {
            title: "Everything is covered",
            description: "A domain name is just the beginning. We'll help you host, design, and manage your site. We'll even build it for you, if you'd like."
        },
        {
            title: "Simple Intuitive",
            description: "We integrate seamlessly with WordPress, WebsiteBuilder, and SiteLock, to name a few. We’ll help you get online with ease."
        },
    ]
  return (
    <div className="max-width mt-20">
      ...
      The total package for starting your website.
              ...
              <p style={{ color: ' rgba(0, 0, 0, 0.60)' }} className="font-merriweather text-[15px] font-400 text-dark-500 leading-6">
              {list.description}
              </p>
                    </div>
                    </div>
