...
const ContactPage = () => {
  ...
  return (
    <>
      <div className="flex gap-10 max-xl:gap-4 mb-16 max-lg:mb-4 ml-[50px] max-xl:ml-0 max-lg:flex-col">
        <div className='py-6  border-gray-300 border rounded-3xl w-[550px] max-xl:w-[380px] max-lg:[700px] max-lg:justify-center'>
      ...
      <div className='flex max-lg:flex-col max-lg:gap-10 mb-10 py-10 max-lg:py-0'>
        <div className='flex flex-col gap-3 w-[330px] max-xl:w-[200px]  pr-4 max-lg:pr-0 max-lg:w-full  border-r-2 max-lg:border-r-0 '>
