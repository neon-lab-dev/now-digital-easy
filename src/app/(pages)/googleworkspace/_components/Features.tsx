...
const Features = () => {
  ...
  const handleCheckAvailability = () => {
    ...
    const similarDomains = ["example1.com", "example2.com", "example3.com"];

    const isDomainAvailable = !existingDomains.includes(inputValue.toLowerCase());
      ...
      <div className="bg-gradient-checkout w-[1000px]  border border-[#000659] shadow-[#00065980] shadow-2xl rounded-xl fixed bottom-6 left-[300px] z-50">
        {showCheckout && (
          <div className="flex justify-between items-center px-6  py-6">
            ...
            <button onClick={handleBuyNow} className="px-8 py-4 rounded-xl bg-[#0009FF] text-white">Buy Now</button>
          </div>
        )}
        {showAvailability && (
          <div className="flex flex-col items-center py-6">
            <div className="flex justify-start items-start w-[900px]">
              <div className="flex items-center ps-4 rounded">
                ...
                />
                <label htmlFor="bordered-radio-register" className="w-full py-4 ms-2 font-medium text-black">
              ...
              <div className="flex items-center ps-4 rounded">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="bordered-radio-existing" className="w-full py-4 ms-2 text-gray-600">
            ...
            <div className="flex justify-center">
              ...
              {chosenOption === "register" ? (
                <button onClick={handleCheckAvailability} className="px-4 py-2 h-[51px] bg-[#0009FF] text-white  shadow-black shadow-md">
                  Check Availability
                </button>
              ) : (
                <button onClick={handleAssignDomain} className="px-7 py-2 h-[51px] bg-[#0009FF] text-white shadow-black shadow-md">
                  Assign Domain
                </button>
              )}
            </div>
            {errorMessage1 && <div>
              ...
              {similarDomains.length > 0 && (
                <div>
                  <div className="flex mr-[600px] gap-10 my-4 mx-2 ">
                    <span className="">{`${inputValue}`}</span>
                    <div className="flex items-center gap-2">
                      <span className=" text-red-500 rounded-[100%] text-[13px] ">X</span>
                      ...
                      <div  key={index}>
                        <div className="flex justify-between items-center gap-10 my-4">
                          ...
                          <div className="flex items-center gap-5">
                            <span>1 year</span>
                            <span>₹980.00</span>
                            <button className=" bg-[#0009FF] text-white rounded-[5px] p-2 shadow-black shadow-md">Add to Cart</button>
                            <hr className=" bg-[#64646480]  h-[2px]" />
                          </div>
                        </div>
                        <hr className=" bg-[#64646480]  h-[2px]" />
              ...
              <tr className="h-[200px]  border border-[#0437CD] border-b-[#AAD0FF] ">
                ...
                <th className="bg-[#F2F3FF]" >
                  <div className="flex flex-col p-2 gap-3">
                    <span className=" max-lg:text-[13px]">Business Starter</span>
                    <span className="text-[28px] max-lg:text-[16px] text-[#0437CD]">₹125/mo</span>
                    <div className="flex justify-center">
                      <button className="bg-[#000AFF] text-white hover:bg-black p-3 max-lg:p-1 w-[180px] max-lg:w-[100px] rounded-lg" onClick={handleContinuetoCheckout}>Add to Cart</button>
                    </div>
                  </div>
                </th>
                <th>
                  <div className="flex flex-col p-2 gap-3">
                    <span className="max-lg:text-[12px]" >Business Standard</span>
                    <span className="text-[28px] max-lg:text-[16px] text-[#0437CD]">₹672/mo</span>
                    <div className="flex justify-center">
                      <button className="bg-[#000AFF] text-white hover:bg-black p-3 w-[180px] max-lg:p-1 max-lg:w-[100px]  rounded-lg">Add to Cart</button>
                    </div>
                  </div>
                </th>
                <th className="bg-[#F2F3FF]">
                  <div className="flex flex-col p-2 gap-3 ">
                    ...
                    <span className="text-[28px] text-[#0437CD] max-lg:text-[16px]">₹1,299/mo</span>
                    <div className="flex justify-center">
                      <button className="bg-[#000AFF] text-white hover:bg-black p-3 w-[180px] max-lg:p-1 max-lg:w-[100px]   rounded-lg">Add to Cart</button>
                    </div>
                  </div>
            ...
            <tbody>
              {servicesData.map((service, index) => (
                <tr key={index} className="h-[80px]  border border-[#0437CD] border-t-[#AAD0FF] border-b-[#AAD0FF] ">
                  ...
                  <th className="w-[440px] max-lg:w-[280px] max-lg:text-[14px] max-md:w-0 px-4 text-start "><span className=" max-md:hidden">{service.title}</span></th>
                  <th className="bg-[#F2F3FF]" ><span className="font-source-sans-pro text-xl  p-2 leading-[7px] max-lg:text-[12px]  ">{service.stater}</span></th>
                  <th>
                    <span className=" font-source-sans-pro text-xl  p-2 leading-xl leading-[7px] max-lg:text-[12px]   ">{service.standand}</span>
                  </th>
                  <th className="bg-[#F2F3FF]"><span className="font-source-sans-pro text-xl  p-2 leading-2xl leading-[7px] max-lg:text-[12px]   ">{service.plus}</span></th>
                </tr>
              ))}
            </tbody>
          </table>
