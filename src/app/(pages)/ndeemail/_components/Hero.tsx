    ...
    return (
        <div className="bg-background-nde">
            <div className="flex justify-center pt-[100px]">
                <div className=" flex justify-center text-center font-900 font-source-sans-pro text-6xl text-[#000659] tracking-0.15 w-[80%] ">
                    <span className="">The customer-centric business email service that helps you grow</span>
                </div>
            </div>
            <div className="flex justify-center pt-8">
                <div className=" flex justify-center text-center font-merriweather tracking-0.15 leaing-[14px] font-700 text-[#151D8C] text-xl w-[650px] ">
            ...
            <div className="flex justify-center pt-8">
                <div className=" flex justify-center text-center text-[#000659] text-lg w-[640px]">
                    <button className="bg-[#0011FF] text-white p-4 font-700  font-source-sans-pro rounded-[50px]">ACCESS NDE MAIL</button>
                </div>
            </div>
            <div className="flex justify-center pt-8 max-lg:pt-[100px]">
                <div className=" flex justify-center relative">
                    ...
                    <button className="bg-black absolute z-10 text-white p-3 rounded-[50px] top-[50%] right-[45%] max-md:right-[30%]">
