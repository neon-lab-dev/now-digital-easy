    ...
    return (
        <>
            ...
            <div className="flex justify-center py-10 gap-4">
                <div className="h-[556px] w-[850px] rounded-xl bg-gradient-card">
                </div>
                <div className="flex flex-col gap-6" >
                    <button className={`rounded-xl w-[381px] h-[92px] border-[3px] bg-[#F8F9FA]  ${activeButton === 'safe' ? 'border-[#1224F1] shadow-lg' : 'border-none'}`} onClick={() => handleClick('safe')}>
                    ...
                    <button className={`rounded-xl w-[381px] h-[92px] border-[3px] bg-[#F8F9FA]  ${activeButton === 'tools' ? 'border-[#1224F1] shadow-lg' : 'border-none'}`} onClick={() => handleClick('tools')}>
                        <div className="flex items-center gap-3 px-3">
                    ...
                    <button className={`rounded-xl w-[381px] h-[92px] border-[3px] bg-[#F8F9FA]  ${activeButton === 'money' ? 'border-[#1224F1] shadow-lg' : 'border-none'}`} onClick={() => handleClick('money')}>
                        <div className="flex items-center gap-3 px-3">
                    ...
                    <button className={`rounded-xl w-[381px] h-[92px] border-[3px] bg-[#F8F9FA]  ${activeButton === 'building' ? 'border-[#1224F1] shadow-lg' : 'border-none'}`} onClick={() => handleClick('building')}>
                        <div className="flex items-center gap-3 px-3">
                    ...
                    <button className={`rounded-xl w-[381px] h-[92px] border-[3px] bg-[#F8F9FA]  ${activeButton === 'people' ? 'border-[#1224F1] shadow-lg' : 'border-none'}`} onClick={() => handleClick('people')}>
                        <div className="flex items-center gap-3 px-3">
