...
const Gateway = () => {
    return (
        <div>
            <div className="flex flex-col gap-4 px-16 text-center items-center py-10">
            ...
            <div className="flex justify-center p-3  pb-16">
                <Image src={gateway} alt="gateway" className="w-[1400px] max-lg:w-[1001px]" />
            </div>
        </div>
    )
}
